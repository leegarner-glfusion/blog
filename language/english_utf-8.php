<?php
//  $Id: english_utf-8.php 15 2011-03-27 00:56:32Z root $
/**
...
$LANG_BLOG = array(
    ...
    'nojavascript' => 'JavaScript needs to be enabled for Advanced Editor. Option can be disabled in the Configuration admin panel.',

// Mailing blog entry
    'send_message' => 'Send Message',
    'mail_article' => 'Mail Article to a Friend',
    'to_name' => 'To Name',
    'to_email' => 'To eMail Address',
    'from_name' => 'From Name',
    'from_email' => 'From eMail Address',
    'short_msg' => 'Short message',
    'all_fld_req' => 'All fields are required',
    'mail_err' => 'There was an error sending your message. Please try again.',
    'mail_success' => 'Message sent successfully.',
    'invalid_email' => 'Please make sure you use a valid eMail address in the Reply To field.',
    'fill_in_fields' => 'Please fill in the Your Name, Reply To, Subject and Message fields',
    'mail_txt' => "This eMail was sent to you by %s at %s because they thought you might be interested in this article from {$_CONF['site_url']}.  This is not SPAM and the eMail addresses involved in this transaction were not saved to a list or stored for later use.",
    'user_wrote' => '%s wrote: ',
    'frontpage' => 'FrontPage',
    'moderation_title' => 'Blog Submissions',
...
$PLG_blog_MESSAGE1 = 'Thank you for your submission.';
$PLG_blog_MESSAGE2 = 'There was an error submitting your article.';
