/*******************************************
 ** Title 2 ID  ****************************
 ** Auto genetare story ID based on title **
 *******************************************/
...
function TitleToId() {
    ...
    // edit here!
    var getTitle = "StoryTitle";
    var setTl2ID = "StoryId";
    var useDigits = true;
    var Separ = "-";
    ...
    var urlID = Title.replace(/\s\s+/g, " ").replace(/\s/g, "_").replace(/\W/g, "").replace(/_/g, Separ);
